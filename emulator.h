...
#define MAX_LINE_LEN 200	//maximum number of characters a line of code may have
#define MAX_OPCODE   12		//number of opcodes supported (length of opcode_str and opcode_func)
